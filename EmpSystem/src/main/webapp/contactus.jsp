...
<body>
    ...
    <div id="home" class="container">
		<h2>Contact Us</h2>
        <p>Email: surendhar@codegnan.com<br>Phone: +91 9701858978<br>Address: Yanamalakuduru,Codegnan Destination <br>Vijayawada, India</p>
    </div>
    ...
    <script>
        function showSection(sectionId) {
            ...
            const backgrounds = {
                home: 'url(https://www.shutterstock.com/image-vector/contact-us-customer-support-hotline-600nw-2402878041.jpg)',
