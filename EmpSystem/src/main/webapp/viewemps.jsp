...
<body>
        		  ...
        		  <c:forEach items="${empList}" var="employee">
        		  		<tr>
							<td>${employee.id}</td>
        		  			...
        		  			<td>
        		  				<a href = 'edit.jsp?id=${employee.id}&name=${employee.name}&email=${employee.email}&password=${employee.password}&age=${employee.age}&gender=${employee.gender}&mobile=${employee.mobile}&department=${employee.department}&address=${employee.address}'>Edit</a>
        		  			</td>
        		  			<td>
    ...
    <script>
        function showSection(sectionId) {
            ...
            const backgrounds = {
                home: 'url(https://img.freepik.com/free-vector/abstract-blue-light-pipe-speed-zoom-black-background-technology_1142-9530.jpg?w=360)',
