...
<body>
    ...
    <div id="home" class="container">
        ...
        <form action = 'edituser'>
            ...
            <input type="text" name="email" value = '<%=request.getParameter("email") %>' required readonly/>
			
			<label for="password">Password</label>
			<input type="password" name="password" value = '<%=request.getParameter("password") %>' readonly/>
