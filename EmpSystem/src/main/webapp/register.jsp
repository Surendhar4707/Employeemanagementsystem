...
<body>
    ...
    <script>
        function showSection(sectionId) {
            ...
            const backgrounds = {
                home: 'url(https://media.istockphoto.com/id/1489059847/vector/background-of-electric-circuit-metal-black.jpg?s=612x612&w=0&k=20&c=Bof_oGrxx0PXKOFSWc2RhY60LalpZ8WQV9n4JqhHuDQ=)',
